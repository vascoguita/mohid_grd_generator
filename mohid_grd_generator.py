...
class mohid_grd_generator:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'mohid_grd_generator_{}.qm'.format(locale))
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('mohid_grd_generator', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/mohid_grd_generator/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Generate MOHID grid'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&MOHID Grid Generator'),
                action)
